...
class ballroom_danceset_parser():
    ...
    def __getitem__(self, index):
        self.generate_class_labels(index)
        return (self.song_and_annotations[0][0], 
                np.array(self.song_and_annotations[0][1]), 
                np.array(self.original_annotations[0][0]))

    def generate_class_labels(self, index):
        ...
        self.original_annotations.append([annotations_in_seconds])
